...
define("EWR_PROJECT_ID", "{47F27D0C-DB77-4771-87C7-137E7E3004F9}", TRUE); // Project ID
...
$EWR_BODY_CLASS = "hold-transition skin-black-light";
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "qpro", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'X0lpp5gukmvgnuuD', TRUE); // Random key for encryption
